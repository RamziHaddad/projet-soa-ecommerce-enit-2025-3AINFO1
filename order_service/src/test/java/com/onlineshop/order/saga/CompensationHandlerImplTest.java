...
class CompensationHandlerImplTest {
        ...
        void testCompensateInventory_Success() {
                ...
                InventoryResponse releaseResponse = new InventoryResponse(true, null, "Inventory released successfully",
                                java.util.List.of());
        ...
        void testCompensateInventory_Failure() {
                ...
                InventoryResponse releaseResponse = new InventoryResponse(false, null, "Release failed",
                                java.util.List.of());
                when(communicationStrategy.releaseInventory("INV-TRANS-001")).thenReturn(releaseResponse);
        ...
        void testCompensatePayment_Success() {
                ...
                PaymentResponse refundResponse = new PaymentResponse(true, null, "Payment refunded successfully", null,
                                null);
        ...
        void testCompensatePayment_Failure() {
                ...
                PaymentResponse refundResponse = new PaymentResponse(false, null, "Refund failed", null, null);
                when(communicationStrategy.refundPayment("PAY-TRANS-001")).thenReturn(refundResponse);
        ...
        void testCompensateShipping_Success() {
                ...
                ShippingResponse cancelResponse = new ShippingResponse(true, null, "Shipping cancelled successfully",
                                null, null);
        ...
        void testExecuteCompensation_FullWorkflow() {
                ...
                when(communicationStrategy.cancelShipping("SHIPPING-001"))
                                .thenReturn(new ShippingResponse(true, null, null, null, null));
                when(communicationStrategy.refundPayment("PAY-TRANS-001"))
                                .thenReturn(new PaymentResponse(true, null, null, null, null));
                when(communicationStrategy.releaseInventory("INV-TRANS-001"))
                                .thenReturn(new InventoryResponse(true, null, null, java.util.List.of()));
